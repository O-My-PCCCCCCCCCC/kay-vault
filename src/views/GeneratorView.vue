<template>
  <div class="genv">
    ...
    <div class="gen-div">─── 此页面生成的密码 ───</div>
...
<style scoped>
.genv { height: 100vh; display: flex; flex-direction: column; background: #0b0e14; font-family: 'Consolas','Courier New',monospace; color: #abb2bf; }
...
.gen-ctrl { padding: 16px 20px 10px; display: flex; flex-direction: column; gap: 10px; flex-shrink: 0; border-bottom: 1px solid #1a1d27; }
...
.gen-div { text-align: center; font-size: 11px; color: #2c313a; padding: 6px 0; flex-shrink: 0; }

.gen-hist { flex: 1; overflow-y: auto; padding: 2px 20px 16px; }
.hist-empty { text-align: center; color: #3b4048; padding: 30px; font-size: 13px; }
